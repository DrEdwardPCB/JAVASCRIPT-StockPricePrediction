 ...
 */
exports.SimpleMovingAverage = (inputData, average) => {
 ...
 * @param {number} average 
 */
exports.WeightedMovingAverage = (inputData, average) => {
    var outputData = inputData.map((e, i) => {
        if (i < average - 1) {
            return 0
        } else {
 ...
 */
exports.ExpotentialMovingAverage = (inputData,average,smoothening)=>{
